...
export default function Header() {
    return <div className="fixed top-0 left-0 w-full h-28 bg-black flex items-center justify-between px-10 border-b-2 border-gray-700 shadow-lg">
        {/* logo */}
        <h1 className="text-4xl font-semibold text-white w-1/5">Quick Tix</h1>

        {/* some options */}
        <div className="flex items-center justify-center w-3/5">
            <div className="flex items-center justify-center gap-8 text-white text-2xl w-full">
                {
                    eventsMenu.map((item) => (
        ...
        <div className="flex items-center justify-end text-lg w-1/5 gap-4">
            <div className="flex items-center justify-center gap-4 text-white text-2xl cursor-pointer"> Sign In</div>
            <div className="flex items-center justify-center gap-4 text-white text-2xl  rounded-full px-4 py-2 bg-blue-700 cursor-pointer"> Sign Up</div>
        </div>
    </div>;
}
